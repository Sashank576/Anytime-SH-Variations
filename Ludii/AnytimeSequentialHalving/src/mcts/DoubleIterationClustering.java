 ...
 * 
 * This Double Iteration Clustering Agent modifies the pruning strategy by testing every possible split of the children nodes
 * For every split, it calculates the Sum of Squared Errors (SSE) and selects the split that minimizes the SSE.
 * Since a dynamic number of nodes can be pruned, the algorithm always multiplies the number of iterations per node by 2 every time it halves the nodes (every round).
 * 
 ...
 */
public class DoubleIterationClustering extends AI
{
	...
	* 	}
	...
	/**
		 ...
		 * @param algo
		 */
	public static void displayHist(ArrayList<Integer> hist, DoubleIterationClustering algo){
